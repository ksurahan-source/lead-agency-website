        ...
        <div className="wrap">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '5rem', fontSize: '1.2rem', lineHeight: '2.4', textAlign: 'justify', color: '#ccc' }}>
            ...
            <article>
              ...
              <p>
                히옵은 틱톡 알고리즘이 '고성과 콘텐츠'로 인식하게 만드는 요소를 공학적으로 분석합니다. 영상의 시청 지속 시간(Retention), 완료율(Completion Rate), 재시청률, 그리고 공유 데이터를 실시간으로 모니터링하여 어떤 크리에이티브 장치가 알고리즘의 선택을 받는지 데이터화합니다. 틱톡 마케팅은 운에 맡기는 것이 아니라, 알고리즘의 선호도를 맞추는 '최적화'의 영역입니다.
              </p>
            </article>
