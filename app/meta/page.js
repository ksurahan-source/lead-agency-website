...
const content = {
  ko: {
    ...
    ch1p1: '우리가 흔히 알고 있는 \'메타 픽셀\'은 더 이상 완벽한 추적 도구가 아닙니다. 브라우저의 지능형 추적 방지(ITP)와 사용자의 광고 차단 플러그인은 마케팅 데이터의 절반 이상을 가리고 있습니다. 데이터가 없는 마케팅은 눈을 감고 활을 쏘는 것과 같습니다. 히옵(HI-OP)은 \'데이터 주권\'을 되찾는 것부터 시작합니다.',
