    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: '8rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiop-orange)', marginBottom: '2rem' }}>메타 광고 | 2025.05.11</div>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>1. 페이스북 픽셀 오류의 3가지 주요 유형</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>2. 유형별 원인과 해결 방법</h2>
            <div style={{ display: 'grid', gap: '2rem' }}>
              {[
                ...
                <div key={i} style={{ padding: '2rem', background: '#fff', border: '2px solid #000' }}>
                  <div style={{ fontWeight: 900, fontSize: '1.4rem', color: 'var(--hiop-orange)', marginBottom: '0.8rem' }}>{label}</div>
          ...
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>3. 픽셀 오류 진단 체크리스트</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '2rem', marginBottom: '2rem' }}>픽셀 오류 무료 진단 신청</h3>
