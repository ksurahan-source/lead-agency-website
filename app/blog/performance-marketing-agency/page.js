    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: '8rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiop-orange)', marginBottom: '2rem' }}>퍼포먼스 마케팅 | 2025.05.11</div>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>1. '광고 집행'과 '퍼포먼스 마케팅'은 완전히 다릅니다</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>2. 에이전시 선택 전 반드시 물어야 할 5가지 질문</h2>
          ...
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>3. 히옵이 다른 이유: 기술 × 전략의 통합</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '2rem', marginBottom: '2rem' }}>히옵과 함께라면 광고비가 매출로 바뀝니다</h3>
