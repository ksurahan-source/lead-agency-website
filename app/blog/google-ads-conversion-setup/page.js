    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: 'clamp(3.5rem, 10vw, 8rem) clamp(1.1rem, 4vw, 2rem)', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiob-orange)', marginBottom: '2rem' }}>구글 애즈 | 2025.05.11</div>
          ...
          <p style={{ fontSize: 'clamp(1.12rem, 3.4vw, 1.8rem)', fontWeight: 700, lineHeight: 1.4, borderLeft: '10px solid var(--hiob-blue)', paddingLeft: '2rem', wordBreak: 'keep-all' }}>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: 'clamp(1.5rem, 5.5vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>1. 전환 설정의 함정: '전환수'와 '전환 가치'는 다릅니다</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: 'clamp(1.5rem, 5.5vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>2. 히옵의 해결 방식: 전환 가치 기반 입찰 구조 설계</h2>
            <p>
          ...
          <div>
            <h2 style={{ fontSize: 'clamp(1.5rem, 5.5vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>3. 기대 효과: 학습 속도 2배, ROAS 개선 즉각 체감</h2>
            <p>
          ...
          <div style={{ background: '#fff', border: '4px solid #000', padding: '3rem' }}>
            <h3 style={{ fontSize: 'clamp(1.3rem, 4.5vw, 2rem)', marginBottom: '1.5rem', wordBreak: 'keep-all' }}>구글 애즈 전환 설정 자가 진단 체크리스트</h3>
            <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gap: '1rem' }}>
              {['✅ 전환 가치(실제 결제금액)가 구글 애즈에 전달되고 있는가?', '✅ 동일 거래 중복 전환을 막는 설정이 되어 있는가?', '✅ 주요 전환 vs 보조 전환 구분이 명확한가?', '✅ 전환 추적 기간이 비즈니스 구매 주기와 맞는가?', '✅ GA4 연동 전환과 구글 태그 전환 중복은 없는가?'].map((item, i) => (
                <li key={i} style={{ fontWeight: 700, fontSize: '1.2rem', padding: '1rem', background: '#f4f4f0', borderLeft: '6px solid var(--hiob-orange)' }}>{item}</li>
              ))}
            </ul>
          </div>

          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: 'clamp(1.3rem, 4.5vw, 2rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>전환 설정 무료 진단을 받아보세요</h3>
