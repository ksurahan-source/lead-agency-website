    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: '8rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>1. 왜 광고 데이터가 누락되는가</h2>
            <p>
            ...
            <div style={{ marginTop: '2rem', display: 'grid', gap: '1rem' }}>
              {[
                ...
                <div key={i} style={{ padding: '1rem 1.5rem', background: '#fff3f0', border: '2px solid var(--hiop-orange)', fontWeight: 700 }}>
                  • {item}
                </div>
              ))}
            </div>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>2. 히옵의 데이터 누락 복구 3단계</h2>
          ...
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>3. 기대 효과: 데이터 복구가 ROAS를 높이는 이유</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '2rem', marginBottom: '2rem' }}>데이터 누락 무료 진단 신청</h3>
