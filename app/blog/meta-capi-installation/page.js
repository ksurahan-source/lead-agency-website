    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: 'clamp(3.5rem, 10vw, 8rem) clamp(1.1rem, 4vw, 2rem)', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiob-orange)', marginBottom: '2rem' }}>기술적 마케팅 | 2025.05.11</div>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: 'clamp(1.55rem, 6vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>1. 픽셀만으로는 부족합니다: 왜 메타 알고리즘이 바보가 되었을까?</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: 'clamp(1.8rem, 5vw, 3rem)', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: 'clamp(1.55rem, 6vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>2. 해결책: 히옵의 Meta CAPI(Conversion API) 최적화 세팅</h2>
            <p>
          ...
          <div>
            <h2 style={{ fontSize: 'clamp(1.55rem, 6vw, 2.5rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>3. 기대 효과: 사라진 ROAS를 다시 찾아옵니다</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: 'clamp(2.2rem, 6vw, 4rem)', textAlign: 'center' }}>
            <h3 style={{ fontSize: 'clamp(1.4rem, 5vw, 2rem)', marginBottom: '2rem', wordBreak: 'keep-all' }}>메타 광고 성과, 지금 바로 복구하세요</h3>
