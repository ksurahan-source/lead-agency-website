    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: '8rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiop-orange)', marginBottom: '2rem' }}>히옵 소개 | 2025.05.11</div>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>1. 히옵이 다른 이유</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>2. 히옵의 서비스 영역</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
              {[
                ...
                <div key={i} style={{ padding: '2rem', background: '#fff', border: '2px solid #000' }}>
                  <div style={{ fontWeight: 900, fontSize: '1.4rem', color: 'var(--hiop-orange)', marginBottom: '1rem' }}>{col.title}</div>
          ...
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>3. 히옵과 함께한 결과</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '2rem', marginBottom: '2rem' }}>히옵과 함께 시작하세요</h3>
