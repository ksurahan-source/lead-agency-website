    ...
    <main className="bg-light min-h-screen">
      ...
      <article className="wrap" style={{ padding: '8rem 2rem', maxWidth: '1000px', margin: '0 auto' }}>
        <header style={{ marginBottom: '6rem' }}>
          <div style={{ fontSize: '1.2rem', fontWeight: 900, color: 'var(--hiop-orange)', marginBottom: '2rem' }}>스타트업 마케팅 | 2025.05.11</div>
        ...
        <section style={{ fontSize: '1.2rem', lineHeight: 2, color: '#111', display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>1. 스타트업 퍼포먼스 마케팅의 특수성</h2>
            <p>
          ...
          <div style={{ background: '#f4f4f0', padding: '3rem', border: '4px solid #000', boxShadow: '10px 10px 0 #000' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>2. 히옵의 스타트업 퍼포먼스 컨설팅 3단계</h2>
          ...
          <div>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem' }}>3. 스타트업이 얻는 것: 빠른 PMF 검증</h2>
            <p>
          ...
          <div style={{ borderTop: '4px solid #000', paddingTop: '4rem', textAlign: 'center' }}>
            <h3 style={{ fontSize: '2rem', marginBottom: '2rem' }}>스타트업 마케팅 무료 컨설팅 신청</h3>
