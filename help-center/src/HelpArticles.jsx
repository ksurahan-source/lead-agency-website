    ...
    case "connect":
      return (
        <>
          <ol className={styles.steps}>
            <li>
              <h2>회원가입하고 이메일 인증하기</h2>
              <p>
                <Link href="/studio/signup?next=%2Fmcp">HIOB 계정 만들기</Link>
                에서 가입하고 받은 이메일로 인증하세요. 계정이 있다면{" "}
                <Link href="/studio/login?next=%2Fmcp">로그인</Link>합니다.
              </p>
            </li>
            <li>
              <h2>브랜드와 프로젝트 준비하기</h2>
              <p>
                <Link href="/mcp">프로젝트 연결 화면</Link>에서 작업할 브랜드와
                프로젝트를 준비하세요. 크레딧은 같은 브랜드의 팀원들이
                공유합니다.
              </p>
            </li>
            <li>
