      ...
      return (
        <>
          <ol className={styles.steps}>
            ...
            <li>
              <h2>내 정보와 작업 공간 설정하기</h2>
              <p><Link href="/onboarding?next=%2Fmcp">내 작업 공간</Link>에서 이름과 개인·업체 사용 여부를 입력하세요. 업체 사용은 업체명도 필요하며 전화번호는 선택입니다. 이미 생성된 작업 공간을 설정하므로 다시 가입하거나 새 공간을 만들 필요가 없습니다.</p>
            </li>
            <li>
