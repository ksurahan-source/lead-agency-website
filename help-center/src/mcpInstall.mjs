...
export const MCP_RELEASE = Object.freeze({
  ...
  verificationUrl: 'https://studio.hi-ob.com/downloads/mcp/compatibility-0.5.0.json',
  compatibility: [
    { platform: 'darwin-arm64', label: 'macOS · Apple Silicon', toolsLabel: '설치·통신·자료 가져오기 통과', renderLabel: '3초 테스트 영상·음원 합성 통과' },
    { platform: 'darwin-x64', label: 'macOS · Intel (실험적)', toolsLabel: '0.5.0 검증 대기', renderLabel: '0.5.0 검증 대기' },
    { platform: 'win32-x64', label: 'Windows · x64', toolsLabel: '0.5.0 검증 대기', renderLabel: 'Docker 경로 제공 · 실기기 검증 대기' },
  ...
  node: '>=22.18.0',
  packageUrl: 'https://studio.hi-ob.com/downloads/mcp/hiob-mcp-0.5.0.tgz',
  sha256: 'd372cb63c1157408b489d27017fda6b1e17842ac4481219b02c02cbfceb61035',
  installerUrl: 'https://studio.hi-ob.com/downloads/mcp/install-0.5.0.sh',
  toolsInstallerUrl: 'https://studio.hi-ob.com/downloads/mcp/install-tools-0.5.0.mjs',
...
export const MCP_VERIFY_PROMPT = 'HIOB MCP의 runtime_check와 project_list를 실행해줘. 서버 버전, 운영체제, 프로젝트 조회 성공 여부, 최종 렌더 지원 여부를 따로 알려줘. 설치 확인 중에는 유료 생성이나 업로드를 실행하지 마. renderBackend와 ready를 확인해줘. Windows/Linux는 로컬 Docker Linux 엔진과 renderer_setup이 필요해. ready=false이면 원인과 설치 절차를 설명하고 보호 장치를 우회하지 마.';
